...
/*
MODULE #6
EMAC module is fixed to work with LAN8720 PHY.
Содержит системные вызовы.
Зависит от CMSIS, Ucos3, main.h, debug.h.
*/
...
#define EMAC_PHY_DEF_ADR         0x00
#define EMAC_PHY_ID              0x0007c0f0   //LAN8720
  
// EMAC Memory Buffer configuration for 16K Ethernet RAM
//параметры EMAC
///HACK: Для экономии памяти используем размер фрагмента EMAC исходя из
///      размера MSS для TCP/IP. По идее, такой зависимости лучше избегать,
///      но мы не хотим иметь незадействованные фрагменты EMAC
#define EMAC_EXPECTED_MSS                        536
#define EMAC_EXPECTED_MTU                        (EMAC_EXPECTED_MSS + 40)
  
#define EMAC_NUM_RX_FRAG                         4
#define EMAC_NUM_TX_FRAG                         2
#define ETH_FRAG_SIZE                            (EMAC_EXPECTED_MTU + 40)
#define EMAC_ETH_MAX_FLEN                        (ETH_FRAG_SIZE)
...
#define PHY_REG_SPEED            0x1F        // Speed test Register
...
//Попытка установить скорость передачи.
//Если EMAC_Init не был выполнен, то всегда будет возвращать false.
