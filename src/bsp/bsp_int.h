...
#define  BSP_INT_SRC_NBR_MCI                               28   /* MCI card                                           */
...
#define  BSP_INT_SRC_NBR_UART4                             34   /* UART4                                              */
#define  BSP_INT_SRC_NBR_SSP2                              35   /* SSP2                                               */
#define  BSP_INT_SRC_NBR_LCD                               36   /* LCD                                                */
#define  BSP_INT_SRC_NBR_GPIO                              37   /* GPIO                                               */
#define  BSP_INT_SRC_NBR_PWM0                              38   /* PWM0                                               */
#define  BSP_INT_SRC_NBR_EEPROM                            39   /* EEPROM                                             */

#define  BSP_INT_SRC_NBR_MAX                               39   /* Interrupt controller maximum source id number      */
#define  BSP_INT_SRC_NBR_TOTAL                             40   /* Total number of sources                            */
