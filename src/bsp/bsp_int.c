...
void  BSP_IntHandlerMCI           (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_MCI);           }
...
void  BSP_IntHandlerUART4         (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_UART4);         }
void  BSP_IntHandlerSSP2          (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_SSP2);          }
void  BSP_IntHandlerLCD           (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_LCD);           }
void  BSP_IntHandlerGPIO          (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_GPIO);          }
void  BSP_IntHandlerPWM0          (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_PWM0);          }
void  BSP_IntHandlerEEPROM        (void)  { BSP_IntHandler(BSP_INT_SRC_NBR_EEPROM);        }
