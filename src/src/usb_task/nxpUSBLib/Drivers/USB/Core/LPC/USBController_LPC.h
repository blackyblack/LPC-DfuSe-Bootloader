...
#define __USBCONTROLLER_LPC_H__
	...
	/* Private Interface - For use in library only: */
		...
		/* Inline Functions: */
			IAR_ATTR_ALWAYS_INLINE static inline void USB_PLL_On(void) ATTR_ALWAYS_INLINE;
			...
			IAR_ATTR_ALWAYS_INLINE static inline void USB_PLL_Off(void) ATTR_ALWAYS_INLINE;
			static inline void USB_PLL_Off(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline bool USB_PLL_IsReady(void) ATTR_WARN_UNUSED_RESULT ATTR_ALWAYS_INLINE;
			static inline bool USB_PLL_IsReady(void)
			{
				return true; // implement later if needed
			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_REG_On(void) ATTR_ALWAYS_INLINE;
			static inline void USB_REG_On(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_REG_Off(void) ATTR_ALWAYS_INLINE;
			static inline void USB_REG_Off(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_OTGPAD_On(void) ATTR_ALWAYS_INLINE;
			static inline void USB_OTGPAD_On(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_OTGPAD_Off(void) ATTR_ALWAYS_INLINE;
			static inline void USB_OTGPAD_Off(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_CLK_Freeze(void) ATTR_ALWAYS_INLINE;
			static inline void USB_CLK_Freeze(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_CLK_Unfreeze(void) ATTR_ALWAYS_INLINE;
			static inline void USB_CLK_Unfreeze(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_Controller_Enable(void) ATTR_ALWAYS_INLINE;
			static inline void USB_Controller_Enable(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_Controller_Disable(void) ATTR_ALWAYS_INLINE;
			static inline void USB_Controller_Disable(void)
			{

			}

			IAR_ATTR_ALWAYS_INLINE static inline void USB_Controller_Reset(void) ATTR_ALWAYS_INLINE;
