...
//применять для отладочных настроек
//#define OS_DEBUG_VERSION        1u

#ifndef OS_SAFETY_CRITICAL_EXCEPTION
#define OS_SAFETY_CRITICAL_EXCEPTION() do \
                                {\
                                  debug_hard("[FATAL] [%s] [%d] SAFETY CRITICAL EXCEPTION\r\n", __FUNCTION__, __LINE__); \
                                }\
                                while(0)
#endif
